...
package br.com.devfest.sp.provider;

import br.com.devfest.sp.appwidget.ScheduleWidgetProvider;
import br.com.devfest.sp.provider.ScheduleContract.Announcements;
import br.com.devfest.sp.provider.ScheduleContract.PeopleIveMet;
import br.com.devfest.sp.provider.ScheduleContract.Blocks;
import br.com.devfest.sp.provider.ScheduleContract.Experts;
import br.com.devfest.sp.provider.ScheduleContract.Feedback;
import br.com.devfest.sp.provider.ScheduleContract.MapMarkers;
import br.com.devfest.sp.provider.ScheduleContract.MapTiles;
import br.com.devfest.sp.provider.ScheduleContract.Rooms;
import br.com.devfest.sp.provider.ScheduleContract.SearchSuggest;
import br.com.devfest.sp.provider.ScheduleContract.Sessions;
import br.com.devfest.sp.provider.ScheduleContract.Speakers;
import br.com.devfest.sp.provider.ScheduleContract.Tags;
import br.com.devfest.sp.provider.ScheduleDatabase.SessionsSearchColumns;
import br.com.devfest.sp.provider.ScheduleDatabase.SessionsSpeakers;
import br.com.devfest.sp.provider.ScheduleDatabase.Tables;
import br.com.devfest.sp.util.SelectionBuilder;
...
import br.com.devfest.sp.Config;
import br.com.devfest.sp.provider.ScheduleContract.*;
import br.com.devfest.sp.util.AccountUtils;
...
import static br.com.devfest.sp.util.LogUtils.LOGD;
import static br.com.devfest.sp.util.LogUtils.LOGV;
import static br.com.devfest.sp.util.LogUtils.makeLogTag;

/**
 * Provider that stores {@link ScheduleContract} data. Data is usually inserted
 * by {@link br.com.devfest.sp.sync.SyncHelper}, and queried by various
