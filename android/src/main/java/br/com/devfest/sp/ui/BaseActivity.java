...
import br.com.devfest.sp.BuildConfig;
import br.com.devfest.sp.Config;
import br.com.devfest.sp.R;
import br.com.devfest.sp.gcm.ServerUtilities;
import br.com.devfest.sp.io.JSONHandler;
import br.com.devfest.sp.provider.ScheduleContract;
import br.com.devfest.sp.sync.ConferenceDataHandler;
import br.com.devfest.sp.sync.SyncHelper;
import br.com.devfest.sp.ui.debug.DebugActionRunnerActivity;
import br.com.devfest.sp.ui.widget.MultiSwipeRefreshLayout;
import br.com.devfest.sp.ui.widget.ScrimInsetsScrollView;
import br.com.devfest.sp.util.AccountUtils;
import br.com.devfest.sp.util.AnalyticsManager;
import br.com.devfest.sp.util.HelpUtils;
import br.com.devfest.sp.util.ImageLoader;
import br.com.devfest.sp.util.LUtils;
import br.com.devfest.sp.util.LoginAndAuthHelper;
import br.com.devfest.sp.util.PlayServicesUtils;
import br.com.devfest.sp.util.PrefUtils;
import br.com.devfest.sp.util.RecentTasksStyler;
import br.com.devfest.sp.util.UIUtils;
import br.com.devfest.sp.util.WiFiUtils;
...
import static br.com.devfest.sp.util.LogUtils.LOGE;
import static br.com.devfest.sp.util.LogUtils.LOGI;
import static br.com.devfest.sp.util.LogUtils.LOGW;
